...
<body>
	<div id="main">
		...
		<tr style="border: 1px solid black">
			...
			<th style="border: 1px solid black">BOOKID</th>
			<th style="border: 1px solid black">ISSUEDATE</th>
			<th style="border: 1px solid black">RETURNDATE</th>
			<th style="border: 1px solid black">NO OF BOOK</th>
		</tr>
		<%
		try{
			Class.forName("oracle.jdbc.driver.OracleDriver");
			Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "manager");
			PreparedStatement pre=con.prepareStatement("select * from libbookissue");
