...
<body>
	<div id="main">
		...
		<select style="width: 200px; height:30px;margin-left:250px;margin-top:25px" name="to">
			...
			%>
		<input type="submit" value="send" name="mail" id="sub">
			</form>
		</article>
		</div>
	</div>
