...
<body>
	<div id="main">
		...
		<tr style="border: 1px solid black">
			...
			<th style="border: 1px solid black">BOOKTITLE</th>
			<th style="border: 1px solid black">AUTHORNME</th>
		...
		try{
			...
			PreparedStatement pre=con.prepareStatement("select * from libaddbook");
